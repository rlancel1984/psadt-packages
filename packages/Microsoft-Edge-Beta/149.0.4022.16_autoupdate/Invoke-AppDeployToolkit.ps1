...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'MicrosoftEdgeBetaEnterpriseX64.msi' -ArgumentList '/qn /norestart ALLUSERS=1'
    ...
    ## Auto-update enabled
    # Edge updates automatisch via Windows Update
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Uninstall' -ProductCode '{56EB18F8-B008-4CBD-B6D2-8C97FE7E9062}'
