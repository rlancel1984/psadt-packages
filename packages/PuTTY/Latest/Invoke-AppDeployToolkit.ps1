...
function Install-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'install --id PuTTY.PuTTY --silent --accept-source-agreements --accept-package-agreements' -PassThru
    ...
    try {
        ...
        $action = New-ScheduledTaskAction \
            ...
            -Argument "-NoProfile -WindowStyle Hidden -Command \"`& { winget upgrade --id PuTTY.PuTTY --silent --accept-package-agreements --accept-source-agreements | Out-File -FilePath \$env:TEMP\\winget_update_PuTTY.log -Append }`\""
...
function Uninstall-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'uninstall --id PuTTY.PuTTY --silent' -PassThru
