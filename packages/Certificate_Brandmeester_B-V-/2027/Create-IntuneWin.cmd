...
REM  App: Certificate_Brandmeester_B.V.
REM  Installer: Brandmeester B.V..p12
REM  
...
if not exist "!TOOLKIT_DIR!\Files\Brandmeester B.V..p12" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\Brandmeester B.V..p12
    echo.
