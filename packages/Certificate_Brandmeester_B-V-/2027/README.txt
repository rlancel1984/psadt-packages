...
║   Certificate_Brandmeester_B.V. 2027                                             
║                                                                        ║
╚════════════════════════════════════════════════════════════════════════╝
...
Path:              C:\Program Files\Brandmeester B.V.\Certificate_Brandmeester_B.V.
File or folder:    Certificate_Brandmeester_B.V..exe
...
────────────────────────────────────────────────────────────────────────
# Detection script voor Certificate_Brandmeester_B.V.
...
foreach ($path in $regPaths) {
    $app = Get-ItemProperty -Path $path -ErrorAction SilentlyContinue | 
           Where-Object { $_.DisplayName -like "*Certificate_Brandmeester_B.V.*" }
    
    if ($app) {
        try {
            $installedVersion = [version]$app.DisplayVersion
            if ($installedVersion -ge $minVersion) {
                Write-Output "Detected: Certificate_Brandmeester_B.V. $installedVersion"
                exit 0
            }
        } catch {
            Write-Output "Detected: Certificate_Brandmeester_B.V."
            exit 0
        }
    }
}
...
$filePaths = @(
    "C:\Program Files\Brandmeester B.V.\Certificate_Brandmeester_B.V.\Certificate_Brandmeester_B.V..exe",
    "C:\Program Files (x86)\Brandmeester B.V.\Certificate_Brandmeester_B.V.\Certificate_Brandmeester_B.V..exe"
)
...
2. Verify detection na installatie:
   ...
   # File check
   Test-Path "C:\Program Files\Brandmeester B.V.\Certificate_Brandmeester_B.V.\Certificate_Brandmeester_B.V..exe"
