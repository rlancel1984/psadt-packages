...
REM  App: CIS CAT Assessor Windows GUI Jre V
REM  Installer: CIS-CAT-Assessor-Windows-GUI-jre-v4.65.0.zip
REM  
...
if not exist "!TOOLKIT_DIR!\Files\CIS-CAT-Assessor-Windows-GUI-jre-v4.65.0.zip" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\CIS-CAT-Assessor-Windows-GUI-jre-v4.65.0.zip
    echo.
