...
$adtSession = @{
    # App variables.
    AppVendor = 'CIS'
    AppName = 'CIS CAT Assessor Windows GUI Jre V'
    AppVersion = '4.65.0'
    AppArch = 'x64'
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'CIS-CAT-Assessor-Windows-GUI-jre-v4.65.0.zip' -ArgumentList '/quiet /norestart' -WindowStyle 'Hidden'
