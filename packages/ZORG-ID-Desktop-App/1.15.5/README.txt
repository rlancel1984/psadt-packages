...
└── Toolkit/Files/ZORG-ID Desktop App for Windows-1.15.5.msi   ← MSI installer (INCLUDED)
...
✅ De MSI installer (ZORG-ID Desktop App for Windows-1.15.5.msi) is AL INCLUDED in deze package!
...
2. Alle bestanden zijn aanwezig - geen extra downloads nodig
   ...
   │   └── Files/
   │       └── ZORG-ID Desktop App for Windows-1.15.5.msi      ✅ INCLUDED
...
Rule type:         MSI
Product code:      {428494EF-BC1D-49BF-8452-9DC51B9A582D}
...
2. Verify detection na installatie:
   ...
   Get-WmiObject -Class Win32_Product | Where-Object {$_.IdentifyingNumber -eq "{428494EF-BC1D-49BF-8452-9DC51B9A582D}"}
   
   # Registry check
   Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{428494EF-BC1D-49BF-8452-9DC51B9A582D}" -ErrorAction SilentlyContinue
