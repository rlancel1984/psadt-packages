...
$adtSession = @{
    # App variables.
    AppVendor = 'AET Mobile B.V.'
    AppName = 'ZORG-ID Desktop App'
    AppVersion = '1.15.5'
    AppArch = ''
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'ZORG-ID Desktop App for Windows-1.15.5.msi' -ArgumentList '/qn /norestart ALLUSERS=1'
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Uninstall' -ProductCode '{428494EF-BC1D-49BF-8452-9DC51B9A582D}'
