...
└── Toolkit/Files/7z2201.msi   ← MSI installer (INCLUDED)
...
✅ De MSI installer (7z2201.msi) is AL INCLUDED in deze package!
...
Rule type:         MSI
Product code:      {23170F69-40C1-2701-2201-000001000000}
...
2. Verify detection na installatie:
   ...
   Get-WmiObject -Class Win32_Product | Where-Object {$_.IdentifyingNumber -eq "{23170F69-40C1-2701-2201-000001000000}"}
   
   # Registry check
   Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{23170F69-40C1-2701-2201-000001000000}" -ErrorAction SilentlyContinue
