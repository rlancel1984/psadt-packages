...
REM  App: TeamViewerMeeting
REM  Installer: TeamViewerMeeting_Setup_x64.exe
REM  
...
if not exist "!TOOLKIT_DIR!\Files\TeamViewerMeeting_Setup_x64.exe" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\TeamViewerMeeting_Setup_x64.exe
    echo.
