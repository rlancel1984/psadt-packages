...
function Install-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'install --id Adobe.Acrobat.Reader.64-bit --silent --accept-source-agreements --accept-package-agreements --scope machine' -PassThru
    ...
    try {
        ...
        $action = New-ScheduledTaskAction `
            ...
            -Argument "-NoProfile -WindowStyle Hidden -Command `"`& { winget upgrade --id Adobe.Acrobat.Reader.64-bit --silent --accept-package-agreements --accept-source-agreements --scope machine | Out-File -FilePath `$env:TEMP\winget_update_AdobeAcrobatReader.log -Append }`"`""
...
function Uninstall-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'uninstall --id Adobe.Acrobat.Reader.64-bit --silent --scope machine' -PassThru
