...
REM  App: LogiOptions Setup
REM  Installer: options_installer.exe
REM  
...
if not exist "!TOOLKIT_DIR!\Files\options_installer.exe" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\options_installer.exe
    echo.
