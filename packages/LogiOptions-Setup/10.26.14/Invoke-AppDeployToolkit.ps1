...
$adtSession = @{
    # App variables.
    AppVendor = 'Logitech Inc.'
    AppName = 'LogiOptions Setup'
    AppVersion = '10.26.14'
    AppArch = 'x86'
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'options_installer.exe' -ArgumentList '/S' -WindowStyle 'Hidden'
