...
REM  App: 7-Zip 25.01 (x64 edition)
REM  Installer: 7z2501-x64.msi
REM  
...
if not exist "!TOOLKIT_DIR!\Files\7z2501-x64.msi" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\7z2501-x64.msi
    echo.
