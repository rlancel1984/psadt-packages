...
$adtSession = @{
    ...
    AppVersion = 'MSIRMSHUTDOWN2ALLUSERS'
    AppArch = 'x64'
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath '7z2501-x64.msi' -ArgumentList '/qn /norestart ALLUSERS=1'
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Uninstall' -ProductCode '{23170F69-40C1-2702-2501-000001000000}'
