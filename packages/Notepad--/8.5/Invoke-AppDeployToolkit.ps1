...
function Install-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'install --id Notepad++.Notepad++ --silent --accept-source-agreements --accept-package-agreements --scope machine' -PassThru
    ...
    try {
        ...
        $action = New-ScheduledTaskAction `
            ...
            -Argument "-NoProfile -WindowStyle Hidden -Command `"`& { winget upgrade --id Notepad++.Notepad++ --silent --accept-package-agreements --accept-source-agreements --scope machine | Out-File -FilePath `$env:TEMP\winget_update_Notepad.log -Append }`"`""
...
function Uninstall-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'uninstall --id Notepad++.Notepad++ --silent --scope machine' -PassThru
