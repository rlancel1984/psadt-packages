...
function Install-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'install --id Notepad++.Notepad++ --silent --accept-source-agreements --accept-package-agreements' -PassThru -IgnoreExitCodes @(0,-1978335135)
...
function Uninstall-ADTDeployment
{
    ...
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'uninstall --id Notepad++.Notepad++ --silent --accept-source-agreements' -PassThru
