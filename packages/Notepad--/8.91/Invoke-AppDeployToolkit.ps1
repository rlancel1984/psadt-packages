...
$adtSession = @{
    ...
    AppScriptDate = '2026-02-03'
    AppScriptAuthor = 'Florian Daminato'
    RequireAdmin = $true
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'npp.8.9.1.Installer.x64.exe' -ArgumentList '/S' -WindowStyle 'Hidden'
...
function Uninstall-ADTDeployment
{
    ...
    # Start-ADTProcess -FilePath 'uninstall.exe' -ArgumentList '/S'
