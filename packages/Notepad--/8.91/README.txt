...
└── Toolkit/Files/npp.8.9.1.Installer.x64.exe   ← EXE installer (INCLUDED)
...
✅ De EXE installer (npp.8.9.1.Installer.x64.exe) is AL INCLUDED in deze package!
...
2. Alle bestanden zijn aanwezig - geen extra downloads nodig
   ...
   │   └── Files/
   │       └── npp.8.9.1.Installer.x64.exe      ✅ INCLUDED
...
• HKEY_LOCAL_MACHINE\SOFTWARE\Notepad\Notepad++
...
Path:              C:\Program Files\Notepad\Notepad++
...
$filePaths = @(
    "C:\Program Files\Notepad\Notepad++\Notepad++.exe",
    "C:\Program Files (x86)\Notepad\Notepad++\Notepad++.exe"
)
...
C:\Program Files\Notepad\Notepad++\Uninstall.exe
...
2. Verify detection na installatie:
   ...
   # File check
   Test-Path "C:\Program Files\Notepad\Notepad++\Notepad++.exe"
