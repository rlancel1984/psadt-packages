...
REM  App: SolidWorks 2026
REM  Installer: SolidWorksSetup.exe
REM  
...
if not exist "!TOOLKIT_DIR!\Files\SolidWorksSetup.exe" (
    echo [ERROR] Installer bestand niet gevonden!
    echo         Verwacht: !TOOLKIT_DIR!\Files\SolidWorksSetup.exe
    echo.
