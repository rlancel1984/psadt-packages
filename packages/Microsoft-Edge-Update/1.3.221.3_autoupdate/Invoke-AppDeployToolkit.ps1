...
$adtSession = @{
    ...
    AppName = 'Microsoft Edge Update'
    AppVersion = '1.3.221.3'
    AppArch = 'x86'
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'MicrosoftEdgeWebview2Setup.exe' -ArgumentList '/quiet /norestart' -WindowStyle 'Hidden'
    ...
    ## Microsoft Edge auto-updates are enabled by default via Windows Update
