...
Rule type:         MSI
Product code:      {430FD4D0-B729-4F61-AA34-91526481799D}
...
2. Verify detection na installatie:
   ...
   Get-WmiObject -Class Win32_Product | Where-Object {$_.IdentifyingNumber -eq "{430FD4D0-B729-4F61-AA34-91526481799D}"}
   
   # Registry check
   Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{430FD4D0-B729-4F61-AA34-91526481799D}" -ErrorAction SilentlyContinue
