...
function Install-ADTDeployment
{
    ...
    Write-ADTLogEntry -Message "Installing Google.Chrome via Winget..." -Severity 1
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'install --id Google.Chrome --silent --accept-source-agreements --accept-package-agreements' -PassThru
...
function Uninstall-ADTDeployment
{
    ...
    Write-ADTLogEntry -Message "Uninstalling Google.Chrome via Winget..." -Severity 1
    $wingetResult = Start-ADTProcess -FilePath $wingetPath -ArgumentList 'uninstall --id Google.Chrome --silent' -PassThru
